...
To start your project click [this link](https://journey.code.cool/v2/project/solo/blueprint/geometry/java).

## Background materials

- <i class="far fa-exclamation"></i> [UML - Unified Modeling Language](https://learn.code.cool/full-stack/#/../pages/general/uml-unified-modeling-language)
